...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'jednorázová archivace'
    ...
    def treat_page(self):
        ...
        header, body, footer = textlib.extract_sections(text, self.current_page.site)
        if len(body) >= 45:
            text = '''{{Seznam archivů}}
{{Jednorázová archivace
|archive             = {{subst:FULLPAGENAME}}/Archiv %(counter)d
|algo                = old(30d)
|counter             = 1
|maxarchivesize      = 100K
|minthreadsleft      = 0
