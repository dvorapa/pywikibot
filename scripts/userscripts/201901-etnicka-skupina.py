...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'standardizace parametru infoboxu'
    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(r'\{\{ *Infobox[ _]-[ _]etnická[ _]skupina', part, flags=re.I):
            ...
            if inBlockTemplate[-1] and not inInlineTemplate[-1] and not inLink[-1] and not inTable[-1] and not inTag[-1]:
                ...
                # part = textlib.replaceExcept(part, r'', r'', self.vyjimky)
                part = textlib.replaceExcept(part, r'\s*\|\s*image\s*= *(?=\n\s*[\|\}])', r'', self.vyjimky)
                part = textlib.replaceExcept(part, r'\|\s*image\s*=', r'| koláž =', self.vyjimky)
