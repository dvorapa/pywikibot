    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(self.infobox, part):
                ...
                part = textlib.replaceExcept(part, self.infobox, r'{{Infobox - animanga/Publikace', self.vyjimky)
            elif part[:2] == '{{':
                ...
                #part = textlib.replaceExcept(part, r'\s*\|\s*žánr\s*=[^\n]*', r'', self.vyjimky)
