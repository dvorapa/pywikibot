...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'sjednocení terminologie dle [[Wikipedie:Bot/Žádosti_o_provedení_práce#Itálie|žádosti]] ze dne 10. 9. 2018'
    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(r'\{\{ *Infobox[ _]-[ _](?:sídlo[ _]světa|region)', part, flags=re.I):
            ...
            if inBlockTemplate[-1] and not inInlineTemplate[-1] and not inTable[-1] and not inTag[-1]:
                ...
                # part = textlib.replaceExcept(part, r'', r'', self.vyjimky)
                part = textlib.replaceExcept(part, r'\| *pojem vyššího celku *= *[Oo]blast', r'| pojem vyššího celku = [[Regiony v Itálii|region]]', self.vyjimky)
                part = textlib.replaceExcept(part, r'\| *forma administrativní jednotky *= *[Oo]blast', r'| forma administrativní jednotky = [[Regiony v Itálii|Region]]', self.vyjimky)
        ...
        text = textlib.replaceExcept(text, r'\[\[ *[Ii]talské[ _]oblasti *\|', r'[[Regiony v Itálii|', self.vyjimky)
        text = textlib.replaceExcept(text, r'\[\[ *[Ii]talské[ _]provincie *\|', r'[[Provincie v Itálii|', self.vyjimky)
