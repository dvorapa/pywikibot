...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'oprava Horova jména'
    ...
    def treat_page(self):
        ...
        text = textlib.replaceExcept(text, r'\|\s*[Hh]orovo[ _]jméno\s*=\s*\<hiero\> *([^\<]+) *\<\/hiero\> *([^\n]*)', r'| Horovo jméno = \1~\2', self.vyjimky)
        text = textlib.replaceExcept(text, r'(\| Horovo jméno = [^~\n]*)~([^\n]+)', r'\1\n | význam Horova jména = \2', self.vyjimky)
        text = textlib.replaceExcept(text, r'(\| Horovo jméno = [^~\n]*)~', r'\1', self.vyjimky)
