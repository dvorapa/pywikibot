...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'překlad parametrů'
    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(r'\{\{ *Infobox[ _]-[ _]linka[ _]metra', part, flags=re.I):
            ...
            if inBlockTemplate[-1] and not inInlineTemplate[-1] and not inLink[-1] and not inTable[-1] and not inTag[-1]:
                ...
                # part = textlib.replaceExcept(part, r'', r'', self.vyjimky)
                part = textlib.replaceExcept(part, r'\|\s*color\s*=', r'| pozadí nadpisů =', self.vyjimky)
                part = textlib.replaceExcept(part, r'\|\s*textcolor\s*=', r'| barva nadpisů =', self.vyjimky)
                part = textlib.replaceExcept(part, r'\|\s*collapsible\s*=', r'| sbalovací =', self.vyjimky)
                part = textlib.replaceExcept(part, r'\|\s*collapsed\s*=', r'| sbalený =', self.vyjimky)
