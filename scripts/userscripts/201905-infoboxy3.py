...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'oprava parametru infoboxu, -zastaralé parametry infoboxu'
    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(r'\{\{\s*Infobox[ _]-[ _]tenista', part, flags=re.I):
            ...
            if inBlockTemplate[-1] and not inInlineTemplate[-1] and not inLink[-1] and not inTable[-1] and not inTag[-1]:
                ...
                part = textlib.replaceExcept(part, r'\n *\|\s*(Grand Slam čtyřhra – nejlepší výsledky|Velké turnaje|Velké turnaje - čtyřhra|Velké turnaje čtyřhra)\s*=\s*[Aa][Nn][Oo] *', r'', self.vyjimky)
