...
class BasicBot(
    ...
    def treat_page(self):
        ...
        text = textlib.replaceExcept(text, r'\|\s*url\s*=\s*https?:\/\/(?:www\.)?worldcat\.org\/oclc\/', r'| oclc = ', self.vyjimky)
        text = textlib.replaceExcept(text, r'\|\s*oclc\s*=\s*(\d+)([^\}\{]*)\|\s*oclc\s*=\s*\1', r'| oclc = \1\2', self.vyjimky)
