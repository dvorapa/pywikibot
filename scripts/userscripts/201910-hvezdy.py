...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'řazení hlavního článku'
    ...
    def treat_page(self):
        ...
        text = textlib.replaceExcept(text, r'\[\[\s*[Kk]ategorie\s*:\s*' + re.escape(self.current_page.title(with_ns=False)) + r'\s*\|\s*\*\s*\]\]', r'[[Kategorie:' + self.current_page.title(with_ns=False) + r'| ]]', self.vyjimky)
