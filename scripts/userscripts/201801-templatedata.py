...
class BasicBot(
    ...
    def treat_page(self):
        ...
        if re.search(r'\< *templatedata *\>', text, flags=re.I):
            with open('templatedata.txt', 'a') as templatedata:
                templatedata.write('# ' + self.current_page.title(asLink=True) + '\n')
