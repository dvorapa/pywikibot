...
class BasicBot(
    ...
    def treat_page(self):
        ...
        for part in pageParts:
            if re.match(r'\{\{\s*(?:Infobox[ _]|NFPA[ _]704|Studenti[ _]píší[ _]Wikipedii|Taxobox|Singly|Expedice-start[ _]a[ _]přistání|F1[ _]Grand[ _]Prix|Kosmické[ _]těleso-(?:dceřiné[ _]těleso|teleskop)|Turnaj[ _]Grand[ _]Slamu)', part, flags=re.I) and not re.match(r'\{\{\s*(?:Infobox[ _](?:začátek|hlavička|obrázek|dvojitá|jednoduchá|konec|položka|chybí|Ročník[ _]fotbalového[ _]turnaje\/Fb|Eurovision\/Legenda|animanga\/Patička|-[ _](?:železniční[ _]trať\/(?:legenda|hlavička)|číslo\/řada|politická[ _]strana\/mandáty|letiště\/(?:RWY|Konec)|budova\/kodbarvy|chemický[ _]prvek\/(?:Legenda|Barva|Text|Skupina|Izotopy)))|Taxobox\/(?:barva|cat|compare|Stupeň[ _]ohrožení|statusWD))', part, flags=re.I):
