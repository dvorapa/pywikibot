...
class BasicBot(
    ...
    def __init__(self, generator, **kwargs):
        ...
        self.shrnuti = 'sloučeny duplicitní šablony'
    ...
    def treat_page(self):
        ...
        text = textlib.replaceExcept(text, r'\{\{ *SouhrnRočník[ _]-[ _](?:doprava|letectví|loďstva)\s*\|\s*Rok *= *(\d*)[^\}]*\}\}', r'{{Souhrn ročníku|rok = \1}}', self.vyjimky)
