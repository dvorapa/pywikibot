...
db_hostname = 'cswiki.analytics.db.svc.eqiad.wmflabs'
db_username = ''
db_password = ''
db_name_format = '{0}_p'
db_connect_file = user_home_path('replica.my.cnf')
...
flickr = {
    'api_key': 'b41e0e0acfba0972ebb19af83d07a809',  # Provide your key!
    'api_secret': '09b262bf153fc19d',  # Api secret of your key (optional)
